...
[`matchHoverNetToTiles()`](https://rdrr.io/pkg/imageTCGAutils/man/matchHoverNetToTiles.html)
computes the scaling factor between HoVerNet nucleus coordinates and
Prov-GigaPath tile coordinates, then assigns each tile a dominant cell
type and nucleus count based on the overlapping nuclei.
